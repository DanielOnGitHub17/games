...
class Seed {
    ...
    event() {
        window.onmousedown = window.ontouchstart = (event) => {
    ...
    static isFalling = false;  // Fix for double falling bug
}
//  columns
